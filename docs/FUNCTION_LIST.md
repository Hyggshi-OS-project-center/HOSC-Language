...
Heuristic used: top-level function definitions in `.c/.cpp/.ts/.js`, excluding `build/` and generated output folders.
...
- `debugHeaderLines`
- `emitDebugRunReport`
- `flashDebugFailureStatusBar`
- `formatCompilerOutputLines`
- `getOrCreateDebugTerminal`
- `getOrCreateTerminal`
- `hbcPathBesideSource`
- `openBytecodeBeside`
- `psSingleQuote`
- `requireActiveHoscDoc`
- `runHoscProcess`
- `runPowerShellWriteHostBatched`
- `runPowerShellWriteHostBlock`
- `sendUnixPrintfBlock`
- `shSingleQuote`
- `updateStatusBar`
