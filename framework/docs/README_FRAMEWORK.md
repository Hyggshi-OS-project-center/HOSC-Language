...
- `text({ x: 20, y: 20, w: 400, h: 40, content: "message" })` — `h` sets the font size directly (text is centered in the box, not shrunk to fit); `w` controls the centering region width
