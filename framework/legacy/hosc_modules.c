/* hosc_modules.c - Legacy framework module registry (deprecated) */
...
static void* core_module_init(HOSCRuntimeContext* context) {
    (void)context;
    printf("core module initialized\n");
    return NULL;
}

static void core_module_cleanup(HOSCRuntimeContext* context, void* module_context) {
    (void)context;
    (void)module_context;
    printf("core module cleaned up\n");
}

static void* core_module_get_function(HOSCRuntimeContext* context, const char* function_name) {
    (void)context;
...
static bool core_module_is_loaded(HOSCRuntimeContext* context) {
    (void)context;
    return true;
}
...
static void* io_module_init(HOSCRuntimeContext* context) {
    (void)context;
    printf("io module initialized\n");
    return NULL;
}

static void io_module_cleanup(HOSCRuntimeContext* context, void* module_context) {
    (void)context;
    (void)module_context;
    printf("io module cleaned up\n");
}

static void* io_module_get_function(HOSCRuntimeContext* context, const char* function_name) {
    (void)context;
    (void)function_name;
    return NULL;
}

static bool io_module_is_loaded(HOSCRuntimeContext* context) {
    (void)context;
    return true;
}
...
static void* math_module_init(HOSCRuntimeContext* context) {
    (void)context;
    printf("math module initialized\n");
    return NULL;
}

static void math_module_cleanup(HOSCRuntimeContext* context, void* module_context) {
    (void)context;
    (void)module_context;
    printf("math module cleaned up\n");
}

static void* math_module_get_function(HOSCRuntimeContext* context, const char* function_name) {
    (void)context;
...
static bool math_module_is_loaded(HOSCRuntimeContext* context) {
    (void)context;
    return true;
}
...
static void* string_module_init(HOSCRuntimeContext* context) {
    (void)context;
    printf("string module initialized\n");
    return NULL;
}

static void string_module_cleanup(HOSCRuntimeContext* context, void* module_context) {
    (void)context;
    (void)module_context;
    printf("string module cleaned up\n");
}

static void* string_module_get_function(HOSCRuntimeContext* context, const char* function_name) {
    (void)context;
...
static bool string_module_is_loaded(HOSCRuntimeContext* context) {
    (void)context;
    return true;
}
...
static void* win32_module_init(HOSCRuntimeContext* context) {
    (void)context;
#ifdef _WIN32
...
static void win32_module_cleanup(HOSCRuntimeContext* context, void* module_context) {
    (void)context;
    (void)module_context;
}

static void* win32_module_get_function(HOSCRuntimeContext* context, const char* function_name) {
    (void)context;
#ifdef _WIN32
...
static bool win32_module_is_loaded(HOSCRuntimeContext* context) {
    (void)context;
#ifdef _WIN32
    return true;
#else
...
static void* gui_module_init(HOSCRuntimeContext* context) {
    hosc_gui_init(context);
    printf("gui module initialized (%s)\n", hosc_gui_backend_name(context));
    return NULL;
}

static void gui_module_cleanup(HOSCRuntimeContext* context, void* module_context) {
    (void)context;
    (void)module_context;
}

static void* gui_module_get_function(HOSCRuntimeContext* context, const char* function_name) {
    (void)context;
...
static bool gui_module_is_loaded(HOSCRuntimeContext* context) {
    (void)context;
    return true;
}
